...
def get_FaceSR_opt():
    ...
    # data dir
    parser.add_argument('--pretrain_model_G', type=str, default='results/n1000_90000_G.pth')
...
def process_images(input_folder, output_folder):
    ...
    for filename in os.listdir(input_folder):
        if filename.endswith(".jpg"):
            ...
            print("save output image in:", output_path)
            

input_folder = '/home/pfi/PFI/PFISAT/CODE/code/ESRGAN/Super-Resolution-Space/results/RGB_vertederos_crops_lowres'
output_folder = '/home/pfi/PFI/PFISAT/CODE/code/ESRGAN/Super-Resolution-Space/results/RGB_vertederos_crops_superresolution'
