...
def main():
    ...
    parser.add_argument('--gpu_ids', type=str, default='0,1,2,3,4')# default='0,1,2,3,4,5,6,7')

    parser.add_argument('--batch_size', type=int, default=1) # 2 default=32
    ...
    parser.add_argument('--niter', type=int, default=100000) # default=100000
    ...
    # data dir
    parser.add_argument('--hr_path', type=list, default=['data/crops/']) 
    parser.add_argument('--lr_path', type=str, default='data/crops_lowres') 
